...
DOWNLOADER_MIDDLEWARES = {
   'jd_spider.middlewares.RandomUserAgentMiddlewares': 200,
    # 'jd_spider.middlewares.ProxyMiddleware': 500,
...
ITEM_PIPELINES = {
   'jd_spider.pipelines.JdElectPipeline': 300,
}
