...
class KaolaSpider(scrapy.Spider):
    ...
    start_urls = [
                  'https://search.kaola.com/category/20504.html?zn=top&zp=category-10-1-1',
                  'https://search.kaola.com/category/20502.html?zn=top&zp=category-10-1-2',
                  'https://search.kaola.com/category/20505.html?zn=top&zp=category-10-1-3',
                  'https://search.kaola.com/category/20506.html?zn=top&zp=category-10-1-4',
                  'https://search.kaola.com/category/20503.html?zn=top&zp=category-10-1-5',
                  'https://search.kaola.com/category/20581.html?zn=top&zp=category-10-1-6']
    ...
    def get_goods_detail(self,response):
        ...
        item['create_time'] = (datetime.datetime.now() - datetime.timedelta(seconds=ran_time)).strftime(
            "%Y-%m-%d %H:%M:%S")
        # item['create_time'] = '2019-04-21 09:45:00'
        yield item
