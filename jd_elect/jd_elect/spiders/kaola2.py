...
class KaolaSpider(scrapy.Spider):
    ...
    start_urls = [
                  'https://search.kaola.com/category/20492.html?zn=top&zp=category-5-1-1',
                  'https://search.kaola.com/category/20493.html?zn=top&zp=category-5-1-2',
                  'https://search.kaola.com/category/20499.html?zn=top&zp=category-5-1-3',
                  'https://search.kaola.com/category/20498.html?zn=top&zp=category-5-1-4',
                  'https://search.kaola.com/category/20497.html?zn=top&zp=category-5-1-5',
                  'https://search.kaola.com/category/21183.html?zn=top&zp=category-6-1-1',
                  ]
    ...
    def get_goods_detail(self,response):
        ...
        item['create_time'] = (datetime.datetime.now() - datetime.timedelta(seconds=ran_time)).strftime(
            "%Y-%m-%d %H:%M:%S")
        # item['create_time'] = '2019-04-20 09:15:00'
        yield item
